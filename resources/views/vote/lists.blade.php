...
.tishi {
    ...
    <body style="">
        ...
        <div class="container">
            <div class="nav">
                <span ><p class="active">十大年度大奖</p></span>  <span class=""><p>厂家十强大奖（电子类）</p></span> <span class=""><p>厂家十强大奖（非电子类）</p></span><span class=""><p>百匠奖</p></span>
            </div>
            <div class="content">
                <div class="box" style="width: 5505px; left: 0px;">
                    ...
                    <ul>
                        ...
                        <li onclick="get(4,32)">100强汽车集团服务商
                        </li>
   ...
   function vote(obj,id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.status=='200'){
                var a=$(obj).parent().prev().children().html();
                $(obj).addClass("dark").html("已投票");
               // alert(a);
               var n=parseInt(a);
               $(obj).parent().prev().children().html(n+1);
               console.log(a);
				$.tipsBox({
							obj: $(obj),
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.status==200){
                    ...
                    {
                        console.log(len);
                    str+='<div class="wy_list_down"><div class="left a1"><span class="rank grade'+(i+0+1)+'">'+(i+0+1)+'</span></div><div class="list_left a2"><img src="'+data.lists[i]['photo']+'" alt=""></div><div class="list_main a3"><h6>'+data.lists[i]['companyname']+'</h6></div><div class="piao a4"><h4 class="hq">'+data.lists[i]['votes']+'</h4></div><div class="delete a5"><div  onclick="vote(this,'+data.lists[i]['id']+')"class="app_download_btn '+data.lists[i]['style']+'"><i></i>'+data.lists[i]['tips']+'</div></div></div>';
